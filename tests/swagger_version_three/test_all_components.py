...
schema_three = {'id': 20, 'name': 'test_object'}


@generator.response(200, schema_one)
...
@generator.response(204, schema_three)
...
class AppTestBase(TestCase):
    ...
    def test(self):
        ...
        correct_swagger_path = os.path.join(
            pathlib.Path(__file__).parent.parent.absolute()
        ) + '/resources/swagger_version_three/all_components_swagger.yaml'
